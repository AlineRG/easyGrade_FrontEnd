...
import { generateProfileForm } from './formTemplates.js';
import { loadContactData, contactoData } from './contact.js';
import { handleFormSubmit } from './submit.js';

export function showProfile(contentBox) {
  ...
  document.getElementById("editProfileForm").addEventListener("submit", function (event) {
    ...
    handleFormSubmit(userData, contactoData);
  });
}
