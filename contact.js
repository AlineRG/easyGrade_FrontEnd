...
export let contactoData = null;

export function loadContactData(userId) {
  fetch(`http://127.0.0.1:8000/contacto/${userId}`)
    ...
    .catch(err => {
      ...
      document.getElementById("editMessage").innerHTML = `<p class="text-red-600">No se pudo cargar el contacto del usuario</p>`;
    });
}
